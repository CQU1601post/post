...
import static configurations.Constants.EMAIL_SMTP_SERVER;
import static configurations.Constants.SEND_EMAIL_ADDRESS;
import static configurations.Constants.SEND_EMAIL_PASSWORD;
...
public final class AssistUtils {
    ...
    public static boolean sendActivationEmailAuthCode(String mEmail,
        ...
        mEmailBuilder.setContent("<a href= url  ></a>三天内完成，否则失效,验证码为</br>"
                 + mAuthCode);
    ...
    public static boolean sendRetrieverPasswordAuthCode(String mEmail,
        ...
        mEmailBuilder.setText("This is actual message");
        mEmailBuilder.setContent("<h2>下面是你的验证码</h2></br>" 
                + mAuthCode);
        mEmailBuilder.setContentType("text/html;charset=utf-8");
