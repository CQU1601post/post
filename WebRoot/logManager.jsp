...
function deleteModel(id){
    if (confirm("是否确定要删除?")) {
        $.ajax({
            type:"get",
            url:"AdminManagerLogical?info=deleteLogManager&visitorId="+id,
...
<body>
  ...
  <table class="top_logo">
   <tr>
    <td class="STYLE1"><div align="center"><span class="STYLE7">日志管理</span></div></td>
   
  </tr>
 </table>
<div style="text-align:center">
<form class="form-inline" role="form"  action="AdminManagerLogical?info=logManagerShow " method="post"
        id="logForm" >

  <div class="form-group ">
    <label  for="pasteType">类别</label>
      <select name="pasteType" id="pasteType" onChange="selectChange()">
  ...
  <button type="submit" class="btn btn-default logManager_table_radio_button">提交</button>
         ...
         <c:if test="${visitorLogs!=null }">
            ...
            <tr class="tr_two">
                ...
                <td width="150" align="center"><%=v.getVisitorpostname()%></td>
                 <td width="150" align="center"><%=v.getAdId()%></td>
                    ...
                    <table width="200">
                        <tr align="center">                    
                            <td width="100" align="center"><a
                                href=" javascript:void(0)" onclick="deleteModel('<%=v.getVisitorid() %>')"
                                class="logManager_delete"
                            >删除 </a></td>
                        </tr>
                    </table>
                </td>
