...
function changeGroupID(id,oldGroupId){
 ...
 //   $(".pasteGroup").fadeIn("slow");
  ...
  <jsp:include page="managertop.jsp" flush="true" />
   ...
   <tr>
    <td height="104"  width="600" colspan="2" valign="middle"  align="center" class="STYLE1"><div align="center"><img src="images/logo02.png"  style="width:252; height:150; align:bottom" /><span  style=" color:#FAA07D;font-size:2.5em;"> 粘贴栏管理</span></div></td>
  </tr>
   </table>
   ...
   <table  class="table_content" >
    ...
    <tr  class="tr_two">
  			...
  			<td bgcolor="#D1EEEE" align="center">
  				<table width="200" >  
  				<tr align="center" bgcolor="#D1EEEE" align="center">	 		
