...
$(function(){
    ...
    $(".pasteManage_pasteGroup_span_delete span").click(function() {
        $(".pasteGroup").fadeOut("slow");
    });
    $(".pasteManage_pasteGroup_input_insert")
            .click(
                    function() {
...
function changeGroupID(id,oldGroupId){
   ...
   var left= document .documentElement.scrollLeft ? document .documentElement.scrollLeft : document .body.scrollLeft; 
    ...
    $(".pasteGroup").css ({"positon":"absolute","top":(top + document.documentElement.offsetHeight/ 2-50)+ "px","left": (left + document.documentElement.offsetWidth/ 2-200)+ "px"}) ; 
